...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      <tr>
        ...
        <td>
          <input type='text' name='cat_name' maxlength="20" value='<?php echo ($catone["cat_name"]); ?>' size='27' /> <font color="red">*</font>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <select name="parent_id">
				  ...
				  <?php if(is_array($catlist)): foreach($catlist as $key=>$v): if($catone["cat_id"] == $v["cat_id"] ): ?><option value="<?php echo ($v["cat_id"]); ?>" selected><?php echo ($v["cat_name"]); ?></option>
				<?php else: ?> 
      ...
      <tr>
        ...
        <td>
          <textarea name='intro' rows="6" cols="48"><?php echo ($catone["intro"]); ?></textarea>
        </td>
      </tr>
      </table>
    ...
    <input type="hidden" name="cat_id" value="<?php echo ($catone["cat_id"]); ?>" /> 
  </form>
</div>
